...
################    Kate H. Kim     #####################
#########################################################
#' Properly citing Data tables in the UTD Event data server
...
citeData <- function(table_name = "") {
  ...
  if(tn == 'cline_phoenix_nyt' || tn == 'cline_phoenix_swb' || tn == 'cline_phoenix_fbis'){
   clines <- c("Althaus, Scott, Joseph Bajjalieh, John F. Carter, Buddy Peyton, and Dan  A. Shalmon. 2017. Cline Center Historical Phoenix Event Data. v.1.0.0. Distributed by Cline Center for Advanced Social Research. June 30.")
