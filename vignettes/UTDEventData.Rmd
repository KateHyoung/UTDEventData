...
The package has a reference class, named `Table()` for users to submit an API key only onec. This function works only with `DataTables()`, `tableVar()`, and `pullData()`. Some basic usages are as follows;
