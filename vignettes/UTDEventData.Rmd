...
This function is **not** case sensitive, so a user may type either lower case or upper case of data table name. However, the full table name as returned by `Table()` should be tentered in the function. For instance, `"cline_Phoenix_swb"` and `"CLINE_PHOENIX_SWB"` will return the same variables, but `"cline_phenix"` will return noting. 
