...
### The `sendQuery()` issue
The aforementioned issue in  `sendQuery()` occurs only in Windows system computers and is related to a memory alloation in user's R system. If a sizible data set is extracted beyond its allocted momery, the error message may returns. If it is the case, please check your RAM momeory and increase its limit as follows; 
```{r, eval = FALSE}
