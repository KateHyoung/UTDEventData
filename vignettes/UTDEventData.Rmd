...
### The `sendQuery()` issue for a Windows operation system 
The aforementioned issue is related to a memory alloation in user's R system. If a sizible data set is extracted beyond its allocted momery, the error messay may returns. If it is the case, please check your RAM momeory and increase its limit as follows; 
```{r, eval = FALSE}
